...
export const AdminSettings: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-serif-display text-[#0C3934]">Store & WhatsApp Settings</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-8 rounded-2xl border border-[#E8E4D8] space-y-6 shadow-xs">
        ...
        {/* Submit */}
        <div className="pt-4 border-t border-[#E8E4D8] flex items-center justify-between">
          <button
            type="button"
            onClick={handleReset}
