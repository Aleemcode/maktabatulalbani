  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold font-serif-display text-[#0C3934]">Store Overview</h1>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Link
            to="/admin/books/new"
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#0C3934] hover:bg-[#0C5149] text-white text-xs font-semibold shadow-xs transition-colors whitespace-nowrap"
          >
          ...
          <Link
            to="/admin/blog/new"
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-white border border-[#E8E4D8] text-[#0C3934] text-xs font-semibold hover:border-[#0C3934] transition-colors whitespace-nowrap shadow-2xs"
          >
      ...
      {/* Recent Books */}
      <div className="bg-white rounded-2xl border border-[#E8E4D8] p-4 sm:p-6 space-y-4 shadow-xs">
        ...
        <div className="divide-y divide-[#F6F2E9]">
          {books.slice(0, 5).map((book) => (
            <div key={book.id} className="py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-4">
              <div className="flex items-center gap-3 min-w-0">
                <img
                  src={book.cover_image}
                  alt={book.title}
                  className="w-9 h-12 object-cover rounded-lg bg-[#F6F2E9] border border-[#E8E4D8] shrink-0"
                />
              ...
              <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4 shrink-0 pl-12 sm:pl-0">
                ...
                <Link
                  ...
                  className="text-xs text-[#0C5149] hover:text-[#0C3934] font-semibold whitespace-nowrap"
                >
                  Edit
                </Link>
              </div>
